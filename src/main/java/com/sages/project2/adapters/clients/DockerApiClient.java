...
public class DockerApiClient {
    ...
    private static String checkSolution(String repoName, String branchName) throws DockerCertificateException, InterruptedException, DockerException {
        final DockerClient docker = DefaultDockerClient.fromEnv().build();

// Bind container ports to host ports
        final String[] ports = {"8099", "22", "8080"};
...
// Exec command inside running container with attached STDOUT and STDERR
        ...
        listOfCommands.add(new String[]{"git", "clone", "--branch", branchName, "--single-branch", "https://github.com/" + GITHUB_ADMIN_USERNAME + "/" + repoName + ".git"});
